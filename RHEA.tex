...
\begin{flushright}
$\copyright$ 2009--2019 Akira Okumura All Rights Reserved
\end{flushright}
...
2019 年現在、Cherenkov Telescope Array の小口径望遠鏡の開発で、焦点面カメラのデータ収集・カメラ制御ソフトウェア開発責任者などを担当している。専門は宇宙線物理学、ガンマ線天文学、光学系設計。2016年から「宇宙素粒子若手の会」と連携し、「ROOT講習会」を開催している。
